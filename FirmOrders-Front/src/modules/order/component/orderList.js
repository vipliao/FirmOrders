        ...
        this.columns = [
            {
                ...
                render: (text, record, index) => {
                    let expressCompany1;
                    if (text === 0) expressCompany1 = '顺丰';
                    else if (text === 1) expressCompany1 = '邮政';
                    else if (text === 2) expressCompany1 = '圆通';
                    else if (text === 3) expressCompany1 = '中通';
                    else if (text === 4) expressCompany1 = '德邦';
                    else if (text === 5) expressCompany1 = '联邦';
                    return (<div>{expressCompany1}</div>)
                }
            }, {
                title: '寄件电话',
                width: 120,
